...
<body>
  ...
  <main class="container-fluid my-2">
  	<h1 class="fonte text-center">Perguntas não respondidas</h1>
  	<ul>
  	<%
  		PerguntaNaoRespondidaDAO pergDao = new PerguntaNaoRespondidaDAO();
  		ResultSet resultado = pergDao.pesquisarTodas();
  		while(resultado.next()) {
  	%>
  	
  	<div class="sugest my-3 row">
  		<p><%=resultado.getInt("NR_PERGUNTA")%> <%=resultado.getString("USUARIO_NM_EMAIL")%></p>
  		<h2 class="ml-3"><%=resultado.getString("DS_PERGUNTA")%></h2>
    </div>
